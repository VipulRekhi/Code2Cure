...
export const translations = {
  en: {
    ...
    transcribingVoice: "Transcribing your speech...",
    heardVoice: "I heard:",
    ...
    // Review Screen & Clinical Summary (Phase 8)
    healthSummaryTitle: "Your Health Summary",
    healthSummarySub: "Please check that everything looks right before we share it with your clinician.",
    mainConcernSection: "Your Main Concern",
    whatYouToldUsSection: "What You Told Us",
    otherSymptomsSection: "Other Symptoms Mentioned",
    healthHistorySection: "Health History",
    medicinesAllergiesSection: "Medicines & Allergies",
    uploadedRecordsSection: "Your Uploaded Records",
    thingsToReviewSection: "Things to Review",
    fullQnASection: "Full Questions & Answers",
    patientReportedMeds: "Reported by You",
    documentReportedMeds: "Found in Uploaded Prescription",
    medDiscrepancyNotice: "Medication information differs between your answer and uploaded record. Please review.",
    noMedsReported: "No regular medicines reported.",
    noAllergiesReported: "No allergies reported.",
    noHistoryReported: "No past medical conditions reported.",
    noOtherSymptoms: "No additional symptoms reported.",
    reviewNotice: "This summary will be shared with your clinician. It is not a medical diagnosis.",
    verifiedByYou: "Verified by you",
    clickToVerify: "I confirm this information is correct",
    summaryForDoctor: "Summary for Doctor",
    reviewSummaryBeforeSubmit: "Please review this complete summary of your answers before sending it to the doctor.",
    submitToClinician: "SUBMIT TO CLINICIAN →",
    reviewAllAnswers: "Review All Answers",
    quickSummary: "Quick Summary",
    loadSummaryError: "We couldn't load your summary right now.",
    tryAgain: "Try again",
    goBack: "Go back",
    ...
    forDuration: "For",
    whereLocation: "Where",
    howBadSeverity: "How bad",
    reviewTitle: "Your Health Summary",
    reviewSubtitle: "Please check that everything looks right before we share it with your clinician.",
    reviewPatient: "Patient Identification",
    reviewSymptoms: "Reported Symptoms",
    reviewDocs: "Your Uploaded Records",
    ...
    submitToDoctor: "SUBMIT TO CLINICIAN →",
    ...
    // AYUSH & Ayurvedic Intake (Phase 9)
    ayushAssessmentTitle: "Ayurvedic Assessment (Dashavidha Pariksha & Ahara-Vihara)",
    ayushAssessmentSub: "Observations collected for Ayurvedic physician evaluation",
    dashavidhaTitle: "Dashavidha Pariksha (10 Intake Parameters)",
    aharaViharaTitle: "Ahara-Vihara (Diet & Lifestyle Assessment)",
    ayushDisclaimer: "Descriptive intake observations for Ayurvedic clinician consultation. Not an autonomous dosha diagnosis or herbal prescription.",
    paramPrakriti: "Prakriti (Natural Tendencies)",
    paramVikriti: "Vikriti (Current Aggravation)",
    paramSara: "Sara (Vitality / Tissue Strength)",
    paramSamhanana: "Samhanana (Body Compactness)",
    paramPramana: "Pramana (Height-Weight Proportions)",
    paramSatmya: "Satmya (Adaptability & Tolerability)",
    paramSattva: "Sattva (Mental Resilience)",
    paramAharaShakti: "Ahara Shakti (Appetite & Agni)",
    paramVyayamaShakti: "Vyayama Shakti (Physical Stamina)",
    paramVaya: "Vaya (Stage of Life)",
    paramDiet: "Ahara (Dietary Pattern)",
    paramBowel: "Koshtha (Bowel Habit)",
    paramSleep: "Nidra (Sleep Quality & Routine)",
    paramActivity: "Vihara (Physical Exertion & Routine)",
  },
  ...
  hi: {
    ...
    transcribingVoice: "आवाज का ट्रांसक्रिप्शन हो रहा है...",
    ...
    // Review Screen & Clinical Summary (Phase 8)
    healthSummaryTitle: "आपका स्वास्थ्य सारांश",
    healthSummarySub: "डॉक्टर के पास भेजने से पहले कृपया जांच लें कि सभी जानकारी सही है।",
    mainConcernSection: "आपकी मुख्य समस्या",
    whatYouToldUsSection: "आपने जो बताया",
    otherSymptomsSection: "अन्य बताए गए लक्षण",
    healthHistorySection: "पिछला स्वास्थ्य इतिहास",
    medicinesAllergiesSection: "दवाइयां और एलर्जी",
    uploadedRecordsSection: "आपके अपलोड किए गए रिकॉर्ड",
    thingsToReviewSection: "समीक्षा के लिए बिंदु",
    fullQnASection: "सभी प्रश्न और आपके उत्तर",
    patientReportedMeds: "आपके द्वारा बताई गई दवाइयां",
    documentReportedMeds: "पर्चे में पाई गई दवाइयां",
    medDiscrepancyNotice: "आपके उत्तर और अपलोड किए गए पर्चे में अंतर है। कृपया समीक्षा करें।",
    noMedsReported: "कोई नियमित दवा नहीं बताई गई।",
    noAllergiesReported: "कोई एलर्जी नहीं बताई गई।",
    noHistoryReported: "पिछली बीमारी का कोई विवरण नहीं।",
    noOtherSymptoms: "कोई अन्य लक्षण नहीं बताया गया।",
    reviewNotice: "यह सारांश आपके डॉक्टर के परामर्श के लिए तैयार किया गया है। यह कोई अंतिम निदान नहीं है।",
    verifiedByYou: "आपके द्वारा सत्यापित",
    clickToVerify: "मैं पुष्टि करता/करती हूँ कि यह जानकारी सही है",
    summaryForDoctor: "डॉक्टर के लिए सारांश",
    reviewSummaryBeforeSubmit: "यह सारांश डॉक्टर को भेजने से पहले कृपया पूरी तरह जाँच लें।",
    submitToClinician: "डॉक्टर को भेजें →",
    reviewAllAnswers: "सभी उत्तरों की समीक्षा करें",
    quickSummary: "त्वरित सारांश",
    loadSummaryError: "इस समय सारांश लोड नहीं हो सका।",
    ...
    forDuration: "अवधि",
    whereLocation: "स्थान",
    howBadSeverity: "तीव्रता",
    reviewTitle: "आपका स्वास्थ्य सारांश",
    ...
    // AYUSH & Ayurvedic Intake (Phase 9)
    ayushAssessmentTitle: "आयुर्वेदिक मूल्यांकन (दशविध परीक्षा एवं आहार-विहार)",
    ayushAssessmentSub: "आयुर्वेदिक चिकित्सक परामर्श के लिए दर्ज किए गए अवलोकन",
    dashavidhaTitle: "दशविध परीक्षा (10 मापदंड)",
    aharaViharaTitle: "आहार-विहार मूल्यांकन (खान-पान व दिनचर्या)",
    ayushDisclaimer: "यह विवरण केवल आयुर्वेदिक डॉक्टर के संदर्भ के लिए मरीज द्वारा दी गई जानकारी पर आधारित है। यह कोई स्वचालित दोष निदान या दवा पर्चा नहीं है।",
    paramPrakriti: "प्रकृति (स्वाभाविक शारीरिक प्रवृत्ति)",
    paramVikriti: "विकृति (वर्तमान शारीरिक असंतुलन)",
    paramSara: "सार (आंतरिक शक्ति व ऊर्जा)",
    paramSamhanana: "संहनन (शरीर व जोड़ों की दृढ़ता)",
    paramPramana: "प्रमाण (कद-काठी व वजन अनुपात)",
    paramSatmya: "सात्म्य (खान-पान व मौसम अनुकूलन)",
    paramSattva: "सत्व (मानसिक धैर्य व संबल)",
    paramAharaShakti: "आहार शक्ति (भूख व पाचन / अग्नि)",
    paramVyayamaShakti: "व्यायाम शक्ति (शारीरिक मेहनत की क्षमता)",
    paramVaya: "वय (आयु का चरण)",
    paramDiet: "आहार (नियमित खान-पान)",
    paramBowel: "कोष्ठ (पेट साफ होने की आदत)",
    paramSleep: "निद्रा (नींद की गुणवत्ता व दिनचर्या)",
    paramActivity: "विहार (शारीरिक गतिविधि व दिनचर्या)",
  },
  ...
  mr: {
    ...
    transcribingVoice: "आवाज मजकुरात रूपांतरित केला जात आहे...",
    ...
    // Review Screen & Clinical Summary (Phase 8)
    healthSummaryTitle: "तुमचा आरोग्य सारांश",
    healthSummarySub: "डॉक्टरांना पाठवण्यापूर्वी सर्व माहिती बरोबर आहे का ते तपासा.",
    mainConcernSection: "तुमचा मुख्य त्रास",
    whatYouToldUsSection: "तुम्ही सांगितलेली माहिती",
    otherSymptomsSection: "इतर नमूद केलेली लक्षणे",
    healthHistorySection: "मागील आजारांचा इतिहास",
    medicinesAllergiesSection: "औषधे आणि अ‍ॅलर्जी",
    uploadedRecordsSection: "तुमचे जोडलेले वैद्यकीय कागदपत्र",
    thingsToReviewSection: "तपासणी आवश्यक असलेल्या बाबी",
    fullQnASection: "सर्व प्रश्न आणि तुमची उत्तरे",
    patientReportedMeds: "तुम्ही सांगितलेली औषधे",
    documentReportedMeds: "कागदपत्रात आढळलेली औषधे",
    medDiscrepancyNotice: "तुम्ही सांगितलेली मात्रा आणि कागदपत्रातील मात्रा यात फरक आढळला आहे. कृपया तपासा.",
    noMedsReported: "चालू असलेली औषधे नाहीत.",
    noAllergiesReported: "कोणतीही अ‍ॅलर्जी नाही.",
    noHistoryReported: "मागील आजारांचा इतिहास नाही.",
    noOtherSymptoms: "इतर कोणतीही लक्षणे नाहीत.",
    reviewNotice: "हा सारांश डॉक्टरांच्या तपासणीसाठी तयार केला आहे. हे वैद्यकीय निदान नाही.",
    verifiedByYou: "रुग्णाने तपासलेले",
    clickToVerify: "मी खात्री करतो/करते की ही माहिती बरोबर आहे",
    summaryForDoctor: "डॉक्टरांसाठी सारांश",
    reviewSummaryBeforeSubmit: "हा सारांश डॉक्टरांकडे पाठवण्यापूर्वी कृपया पूर्ण तपासा.",
    submitToClinician: "डॉक्टरांकडे पाठवा →",
    reviewAllAnswers: "सर्व प्रश्नांची उत्तरे पहा",
    quickSummary: "थोडक्यात सारांश",
    loadSummaryError: "सध्या सारांश लोड करता आला नाही.",
    tryAgain: "पुन्हा प्रयत्न करा",
    goBack: "मागे जा",
    ...
    whereLocation: "स्थान",
    howBadSeverity: "तीव्रता",
    reviewTitle: "तुमचा आरोग्य सारांश",
    ...
    // AYUSH & Ayurvedic Intake (Phase 9)
    ayushAssessmentTitle: "आयुर्वेदिक मूल्यांकन (दशविध परीक्षा आणि आहार-विहार)",
    ayushAssessmentSub: "आयुर्वेदिक वैद्यकीय सल्लामसलतीसाठी नोंदवलेली माहिती",
    dashavidhaTitle: "दशविध परीक्षा (१० मापदंड)",
    aharaViharaTitle: "आहार-विहार मूल्यांकन (खानपान व जीवनशैली)",
    ayushDisclaimer: "ही माहिती केवळ आयुर्वेदिक वैद्यांच्या तपासणीसाठी रुग्णाने सांगितलेल्या लक्षणांवर आधारित आहे. हे कोणतेही स्वयंचलित दोष निदान किंवा औषधोपचार नाही.",
    paramPrakriti: "प्रकृती (नैसर्गिक शारीरिक प्रवृत्ती)",
    paramVikriti: "विकृती (सध्याचे शारीरिक असंतुलन)",
    paramSara: "सार (अंतर्गत ताकद व उत्साह)",
    paramSamhanana: "संहनन (शरीराचा व सांध्यांचा भक्कमपणा)",
    paramPramana: "प्रमाण (उंची व वजनाचे प्रमाण)",
    paramSatmya: "सात्म्य (अन्न व हवामान सहनशीलता)",
    paramSattva: "सत्व (मानसिक बळ व संयम)",
    paramAharaShakti: "आहार शक्ती (भूक व पचन / अग्नी)",
    paramVyayamaShakti: "व्यायाम शक्ती (शारीरिक कष्टाची क्षमता)",
    paramVaya: "वय (आयुष्याचा टप्पा)",
    paramDiet: "आहार (दैनंदिन जेवणाची पद्धत)",
    paramBowel: "कोष्ठ (पोट साफ होण्याची सवय)",
    paramSleep: "निद्रा (झोपेचे प्रमाण व शांतता)",
    paramActivity: "विहार (शारीरिक हालचाल व दिनचर्या)",
  },
};
